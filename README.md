...
* [gnosis-markdown](https://github.com/SHCV-it/gnosis) - A command-line tool and Python library that fetches web pages into Markdown for LLM/RAG use, writing WARC alongside a byte-level provenance record (source URL, UTC timestamp, SHA-256, redirect chain, extraction fidelity). *(In Development)*
